#!perl
#
# Install script for DBConnectorPlugin
#
...
Foswiki::Extender::install( $PACKAGES_URL, 'DBConnectorPlugin', 'DBConnectorPlugin', @DATA );
...
__DATA__
<<<< MANIFEST >>>>
lib/Foswiki/Plugins/DBConnectorPlugin.pm,0444,Plugin Perl module
lib/Foswiki/Plugins/DBConnectorPlugin/Config.spec,0444,
data/System/DBConnectorPlugin.txt,0664,Plugin topic
templates/editdbfield.tmpl,0444,Template
data/System/DBConnectorPluginCreateTableQuery.txt,0664,Plugin topic

<<<< DEPENDENCIES >>>>
DBI,>0,1,cpan,Required
DBD::SQLite,>0,1,cpan,Optional
